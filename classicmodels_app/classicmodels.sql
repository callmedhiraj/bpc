...
--
-- Host: localhost
-- Generation Time: Sep 16, 2023 at 03:03 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllOrderDetailsByCustomerNumber` (IN `cno` INT)   BEGIN
SELECT 
...
('ASDF007', 'Kathmandu', '9851197672', 'test', 'test', '3', 'Nepal', '44600', 'Nepal'),
('ASDF334', 'Kathmandu', '9851197621', 'Sanepa', 'Gaushala', '3', 'Nepal', '44600', 'Nepal');
...
INSERT INTO `tbl_admin` (`admin_id`, `username`, `password`, `email`, `admin_status`) VALUES
(1, 'admin', '52943f898601a520af8dde488b08bf25c2b2f913', 'admin@gmail.com', 1),
(2, 'radha', '243fd72a148ec1a24d6d87b4137cc382c6ba79ba', 'radha@gmail.com', 1),
(3, 'muskan', 'fc62bca205631f03706059d8f2d489264d4bde4c', 'muskan@gmail.com', 1);
